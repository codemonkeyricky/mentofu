...
describe('Parent Dashboard E2E Test', () => {
  ...
  describe('Parent Dashboard Multiplier Management', () => {
    ...
    it('should reject invalid multiplier updates', async () => {
      ...
      expect(invalidQuizResponse.body.error).toHaveProperty('message', 'Invalid quiz type. Must be one of: simple-math, simple-math-2, simple-math-3, simple-math-4, simple-math-5, simple-math-6, simple-remainder, simple-words, addition-test');
    });
  });
