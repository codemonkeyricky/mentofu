...
// LCD quiz module for finding lowest common denominators
export default class LCDQuiz extends QuizBase {
    ...
    async startQuiz() {
        try {
            ...
            this.currentQuizType = 'simple-math-6';

            // Fetch new session from API
            const response = await fetch('/session/simple-math-6', {
                method: 'GET',
                headers: {
            ...
            if (button) {
                ...
                button.innerHTML = originalHTML || this.getDefaultButtonHTML('simple-math-6');
            }
        }
    }
