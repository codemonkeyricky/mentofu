...
export default class BODMASQuiz extends QuizBase {
    ...
    async startQuiz() {
        try {
            ...
            const button = this.mathMasterPro.startMath4Btn;
            if (button) {
            ...
            this.currentQuizType = 'math-4';

            // Fetch new session from API
            const response = await fetch('/session/simple-math-4', {
                method: 'GET',
                headers: {
            ...
            if (button) {
                ...
                button.innerHTML = originalHTML || this.getDefaultButtonHTML('math-4');
            }
        }
    }
